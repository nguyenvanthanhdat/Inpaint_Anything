...
from Inpaint_Anything.lama.saicinpainting.evaluation.masks.mask import SegmentationMask
from Inpaint_Anything.lama.saicinpainting.utils import LinearRamp
